...
private:
	...
	*/
	...
	static int __stdcall NewMultiByteToWideChar(
	...
	static int __stdcall NewCompareStringW(
...
public:
	...
	BOOL				m_bNoAslr;
	INT					m_nHookType;
	// BOOL				Decode(LPCSTR cszJpnCode, LPSTR szKorCode);
	BOOL				IsKorean(LPCSTR pszTestString);
	BOOL				m_bCompareStringW;
